/* Varan: Windows ARM32 (Thumb-2) ffvpx config. Derived from
   config_win64_aarch64.h with ARCH_AARCH64/ARM + all NEON/VFP/ARMv8 SIMD forced to 0
   and HAVE_FAST_64BIT 0 -> generic 32-bit C build (no x86 or ARM asm). The FFMPEG_-
   CONFIGURATION / CC_IDENT strings below are inherited from the arm64 source and are
   descriptive only. */
