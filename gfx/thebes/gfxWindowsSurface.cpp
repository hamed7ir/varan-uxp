...
// Varan (M5 Lever D): restore the D3D9-surface ctor (revert Issue #1841 Part 2). cairo owns the
// GetDC/ReleaseDC lifetime internally via cairo_win32_surface_create_with_d3dsurface9.
