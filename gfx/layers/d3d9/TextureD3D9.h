...
// Varan (M5 Lever D): DXGID3D9TextureData was MOVED to D3D9SurfaceImage.h after the 2022
// D3D9-compositor removal (byte-identical). Include it here at GLOBAL scope (never mid-namespace).
...
// Varan (M5 Lever D): DXGID3D9TextureData now lives in D3D9SurfaceImage.h (included at file top).
