...
// Varan (M5 Lever D): DXGID3D9TextureData impls live in D3D9SurfaceImage.cpp now (moved after the
// 2022 D3D9-compositor removal). Removed the duplicate here to avoid duplicate-symbol at link.
